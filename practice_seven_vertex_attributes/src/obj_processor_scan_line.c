...
void *obj_processor_paint_surfaces_scan_line_parallel_worker(void *thread_arguments){
    ...
    //obj_processor_three_dimensions_model_vertex *thread_image_space_vertices = obj_processor_paint_surfaces_scan_line_parallel_filter_active_thread_vertices(arguments->image_space_vertices);
...
/*
void obj_processor_paint_surfaces_scan_line_parallel_filter_active_thread_vertices(obj_processor_three_dimensions_model_vertex *image_space_vertices, int vertex_count, int scan_line_start_y, int scan_line_end_y, obj_processor_three_dimensions_model_vertex **active_thread_vertices, int *active_thread_vertex_count){
    *active_thread_vertices = (obj_processor_three_dimensions_model_vertex *)malloc(sizeof(obj_processor_three_dimensions_model_vertex *) * vertex_count);
    int vertex_index;
    for(vertex_index = 0, *active_thread_vertex_count = 0; vertex_index < vertex_count; vertex_index++){
        obj_processor_three_dimensions_model_vertex *vertex = image_space_vertices + vertex_index;
        int is_vertex_active_in_thread = 0;
        if(vertex->start_point->y >= scan_line_start_y && vertex->start_point->y < scan_line_end_y) is_vertex_active_in_thread = 1;
        else if(vertex->end_point->y >= scan_line_start_y && vertex->end_point->y < scan_line_end_y) is_vertex_active_in_thread = 1;
        if(!is_vertex_active_in_thread) continue;
        obj_processor_three_dimensions_model_vertex *active_thread_vertex = *active_thread_vertices + active_thread_vertex_count;
        active_thread_vertex
        return 1;
    }
}
*/
...
void obj_processor_paint_surfaces_scan_line(obj_processor_three_dimensions_model *model, obj_processor_three_dimensions_model_vertex *image_space_vertices, ppm_processor_canvas *canvas, ppm_processor_pixel *background_pixel_template){
    ...
    for(scan_line_index_y = (canvas->height / 2) * -1; scan_line_index_y < canvas->height / 2 - 2; scan_line_index_y++){
        ...
        for(scan_line_index_x = (canvas->width / 2) * -1, active_sides_index = 0; scan_line_index_x < canvas->width / 2 - 2; scan_line_index_x++){
            ...
            if(paint_surface != NULL) surface_pixel_template = obj_processor_get_pixel_paint_color(paint_surface, image_space_vertices, model->vertices_attributes);
...
ppm_processor_pixel *obj_processor_get_pixel_paint_color(obj_processor_scan_line_surface *paint_surface, obj_processor_three_dimensions_model_vertex *image_space_vertices, obj_processor_three_dimensions_model_vertex_attributes *vertices_attributes){
    ...
    obj_processor_three_dimensions_model_vertex_attributes *vertex_attributes = vertices_attributes + vertex_index;
    ppm_processor_pixel *pixel_template = (ppm_processor_pixel *)malloc(sizeof(ppm_processor_pixel));
    ppm_processor_paint_pixel(pixel_template, vertex_attributes->red, vertex_attributes->green, vertex_attributes->blue);
