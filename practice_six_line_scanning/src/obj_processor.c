...
obj_processor_three_dimensions_model *obj_processor_get_three_dimensions_model(long vertex_count, long faces_count){
    ...
    obj_processor_three_dimensions_model_vertex_attributes *vertices_attributes = (obj_processor_three_dimensions_model_vertex_attributes *)calloc(vertex_count, sizeof(obj_processor_three_dimensions_model_vertex_attributes));
    ...
    model->vertices_attributes = vertices_attributes;
    model->faces = faces;
    return model;
}
