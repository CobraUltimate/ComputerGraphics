...
typedef struct obj_processor_three_dimensions_model_vertex_attributes{
    int red;
    int green;
    int blue;
} obj_processor_three_dimensions_model_vertex_attributes;
...
typedef struct obj_processor_three_dimensions_model{
    ...
    obj_processor_three_dimensions_model_vertex_attributes *vertices_attributes;
